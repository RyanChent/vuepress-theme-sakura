  ...
  var sure = function () {
      ...
      botui.message
        ...
        .then(function () {
          botui.message
            .add({
              delay: 1500,
              content: "向往成为技术大神进入软件专业，然而还是一介码农",
            })
            .then(function () {
              botui.message
                .add({
                  delay: 1200,
                  content: "因为爱折腾而经常的Coding",
                })
                .then(function () {
                  botui.message
                    .add({
                      delay: 1500,
                      content:
                        "主攻 HTML/ CSS/ JavaScript ，偶尔也折腾Python/C/Nodejs",
                    })
                    .then(function () {
                      botui.message
                        .add({
                          delay: 1500,
                          content: "喜欢听歌，尤其是韩文歌曲",
                        })
                        .then(function () {
                          botui.message
                            .add({
                              delay: 1800,
                              content: "也喜欢画画，觉得画画可以锻炼集中力",
                            })
                            .then(function () {
                              botui.action
                                .button({
    ...
    thirdpart = function () {
      botui.message
        .add({
          delay: 1e3,
          content: "没有啥特殊意义呢，自己给自己瞎编的一个英文名~ O(∩_∩)O哈哈~",
        })
        .then(function () {
          botui.action
            .button({
    ...
    fourthpart = function () {
      botui.message
        .add({
          delay: 1e3,
          content: "因为单纯觉得有趣，爱折腾…… ",
        })
        .then(function () {
          botui.message
            .add({
              delay: 1100,
              content: "而且我喜欢有个地方可以写些东西！",
            })
            .then(function () {
              botui.action
                .button({
            ...
            .then(function () {
              botui.message
                .add({
                  delay: 1600,
                  content:
                    "也可以关注我的公众号![公众号](https://jarrychen.xyz/images/about/my_public.jpg) ~",
                })
                .then(function () {
                  botui.message.add({
                    delay: 1600,
                    content:
                      "或者加我个人微信![个人微信](https://jarrychen.xyz/images/about/my_wechat.jpg)，与我进行交流O(∩_∩)O哈！~",
                  });
                });
            });
        });
